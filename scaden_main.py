...
def training(data_path, train_datasets, model_dir, batch_size, learning_rate, num_steps):
    ...
    with tf.Session() as sess:
        cdn512 = Scaden(sess=sess,
                     ...
                     learning_rate=learning_rate,
                     num_steps=num_steps)
        cdn512.hidden_units = architectures['m512'][0]
        cdn512.do_rates = architectures['m512'][1]
    ...
    with tf.Session() as sess:
        cdn1024 = Scaden(sess=sess,
                      ...
                      learning_rate=learning_rate,
                      num_steps=num_steps)
        cdn1024.hidden_units = architectures['m1024'][0]
        cdn1024.do_rates = architectures['m1024'][1]
